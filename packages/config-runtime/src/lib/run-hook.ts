...
import type { Hook, ShellHook } from "@neon/config";
 ...
 *   instead of hanging). Returns `undefined` (shell hooks have no return channel). A
 *   non-zero exit throws {@link HookExecutionError} and stops the chain.
