 ...
 * `@neon/config`) — call it directly only where you don't already have a `GitContext`
 * (e.g. `neon git sync` deriving the default Neon branch name for the current git branch).
 *
