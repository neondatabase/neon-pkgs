		...
		.command(
			...
			(yargs) =>
				yargs.options({
					...
					hipaa: {
						describe:
							projectCreateRequest["project.settings.hipaa"]
								.description,
						type: "boolean",
					},
					name: {
						describe:
							projectCreateRequest["project.name"].description,
						type: "string",
					},
					"region-id": {
					...
					role: {
						describe:
							projectCreateRequest["project.branch.role_name"]
								.description,
						type: "string",
					},
					"pg-version": {
		...
		.command(
			...
			(yargs) =>
				yargs.options({
					...
					hipaa: {
						describe:
							projectUpdateRequest["project.settings.hipaa"]
								.description,
						type: "boolean",
					},
					cu: {
