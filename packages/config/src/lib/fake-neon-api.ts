...
export class FakeNeonApi implements NeonApi {
	...
	/** Test helper: attach a trigger to a branch. */
	seedTrigger(
		projectId: string,
		branchId: string,
